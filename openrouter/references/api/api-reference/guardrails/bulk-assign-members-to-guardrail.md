...
|-------|------|----------|-------------|
| member_user_ids | array of strings | Yes | Array of member user IDs to assign to the guardrail |
...
|-------|------|-------------|
| assigned_count | number (double) | Number of members successfully assigned |
